...
public interface Sweep
{
	 ...
	 * @param numRuns The number of runs (used by stochastic sweeps). 
	 ...
	 */
	public java.util.List<ParameterMap> generateMaps(Random rng, int numRuns) throws SweepLengthException, DuplicateParameterException;
}
